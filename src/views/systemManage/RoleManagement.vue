...
<script>
    export default{
        ...
        methods:{
            ...
            getTableData(){
                this.loading = true
                this.$axios.get('/fline/role/page',{
                    params:{
            ...
            handleOkPower(e) {
                ...
                this.$axios.post('/fline/role/assignPermission', this.$qs.stringify({
            ...
            //删除角色
            onDelete (datas) {
                this.$axios.delete(`/fline/role/remove?id=${datas.id}&version=${datas.version}`).then(data=>{
                    if (data.data.code === 200) {
                        this.$message.success(data.data.msg);
                    }
                    this.getTableData();
            ...
            handleOk(e) {
                if(this.okBtn==0){
                    var url='/fline/role/create';
                }else{
                    var url='/fline/role/update';
                }
                e.preventDefault();
